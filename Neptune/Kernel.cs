...
namespace Neptune
{
    public class Kernel : Sys.Kernel
    {
        ...
        public readonly static int commit = 2; // only update on commits that change the code! if you are just changing the readme or some assets then don't increment this
